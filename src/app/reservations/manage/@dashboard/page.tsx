        ...
        <form action={addCar}>
          ...
          <div className="flex items-center w-1/2 my-2">
            ...
            <input
              ...
              w-full p-2 text-gray-700 focus:outline-none focus:border-blue-400"
            />
          </div>
          <div className="flex items-center w-1/2 my-2">
            ...
            <input
              ...
              max={50}
              className="bg-white border-2 border-gray-200 rounded 
              w-auto p-2 text-gray-700 focus:outline-none focus:border-blue-400"
            />
          ...
          <button
            type="submit"
            className="rounded bg-blue-500 hover:bg-blue-700 text-white p-2"
          >
            Add New Car
          </button>
        </form>
